...
caffe_root = "/home/bobby/Documents/PROG/MICA/C3D/C3D-v1.0/"
...
For example, "python {} {}" will extract features from an example image.'''.format(
    ...
    tmp_dir = '/home/bobby/Documents/PROG/MICA/UCF101_Frame'
    ...
    sample_every_N_sec = 2*num_frames_per_clip/fps
    ...
    feature_prototxt = os.path.join(
                               caffe_root,
                               "examples/c3d_feature_extraction/c3d_sport1m_feature_extractor_frm.prototxt"
                              )
    ...
    f_output_prefix = open(output_prefix_file, 'a')
