...
namespace protobuf_caffe_2fproto_2fcaffe_5fpretty_5fprint_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "caffe/proto/caffe_pretty_print.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::caffe::protobuf_caffe_2fproto_2fcaffe_2eproto::InitDefaults();
...
void AddDescriptorsImpl() {
  ...
  ::caffe::protobuf_caffe_2fproto_2fcaffe_2eproto::AddDescriptors();
...
NetParameterPrettyPrint::NetParameterPrettyPrint()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_caffe_2fproto_2fcaffe_5fpretty_5fprint_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* NetParameterPrettyPrint::descriptor() {
  protobuf_caffe_2fproto_2fcaffe_5fpretty_5fprint_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_caffe_2fproto_2fcaffe_5fpretty_5fprint_2eproto::file_level_metadata[0].descriptor;
}
...
::google::protobuf::Metadata NetParameterPrettyPrint::GetMetadata() const {
  protobuf_caffe_2fproto_2fcaffe_5fpretty_5fprint_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_caffe_2fproto_2fcaffe_5fpretty_5fprint_2eproto::file_level_metadata[0];
}
