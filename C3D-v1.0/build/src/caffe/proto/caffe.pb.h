...
class BlobProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.BlobProto) */ {
 ...
 private:
  ...
  friend struct  protobuf_caffe_2fproto_2fcaffe_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class VolumeDatum : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.VolumeDatum) */ {
 public:
  ...
  inline VolumeDatum* New() const PROTOBUF_FINAL { return New(NULL); }

  VolumeDatum* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class LayerParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.LayerParameter) */ {
 ...
 private:
  ...
  void set_has_down_sampling_param();
  void clear_has_down_sampling_param();
  void set_has_layer();
...
class DownSamplingParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.DownSamplingParameter) */ {
 public:
  ...
  inline DownSamplingParameter* New() const PROTOBUF_FINAL { return New(NULL); }

  DownSamplingParameter* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  void set_has_type();
  void clear_has_type();
  void set_has_spatial_factor();
  void clear_has_spatial_factor();
  void set_has_temporal_factor();
  void clear_has_temporal_factor();
...
class ConvolutionParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.ConvolutionParameter) */ {
 ...
 private:
  ...
  void set_has_kernel_depth();
  void clear_has_kernel_depth();
  void set_has_stride();
  void clear_has_stride();
  void set_has_temporal_stride();
  void clear_has_temporal_stride();
  void set_has_weight_filler();
  void clear_has_weight_filler();
  void set_has_bias_filler();
  void clear_has_bias_filler();
  void set_has_filter_group();
  void clear_has_filter_group();
  void set_has_temporal_pad();
  void clear_has_temporal_pad();
...
class DataParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.DataParameter) */ {
 ...
 private:
  ...
  void set_has_show_data();
  void clear_has_show_data();
...
class ImageDataParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.ImageDataParameter) */ {
 ...
 private:
  ...
  void set_has_new_length();
  void clear_has_new_length();
  void set_has_show_data();
  void clear_has_show_data();
  void set_has_use_image();
  void clear_has_use_image();
  void set_has_sampling_rate();
  void clear_has_sampling_rate();
  void set_has_use_label();
  void clear_has_use_label();
  void set_has_use_temporal_jitter();
  void clear_has_use_temporal_jitter();
  void set_has_mean_value();
  void clear_has_mean_value();
  void set_has_num_truth_channels();
  void clear_has_num_truth_channels();
  void set_has_use_byte_input();
  void clear_has_use_byte_input();
  void set_has_is_flow();
  void clear_has_is_flow();
  void set_has_truth_scale();
  void clear_has_truth_scale();
  void set_has_clip_min();
  void clear_has_clip_min();
  void set_has_clip_max();
  void clear_has_clip_max();
...
class AggregationParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.AggregationParameter) */ {
 public:
  ...
  inline AggregationParameter* New() const PROTOBUF_FINAL { return New(NULL); }

  AggregationParameter* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  void set_has_aggregation_param_r();
  void clear_has_aggregation_param_r();
